const items = [
  "SYNAPSES GROUP", "·", "HUMANITY'S CONTINUITY COMPANY", "·",
  "CAPITAL", "·", "TECHNOLOGY", "·", "VAULT", "·",
  "INTELLIGENCE", "·", "MEDIA", "·", "BIO", "·",
...
export function Ticker() {
  ...
  return (
    <div className="overflow-hidden border-y border-border bg-ghost/40 py-3" aria-label="Synapses Group principles">
